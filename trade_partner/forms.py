...
class ProductDetailForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('trade_partner', 'description', 'price', 'category',
                  'seller_full_name', 'seller_phone_number',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Field('price', wrapper_class='form-group col-md-3 mb-0', autocomplete='off', css_class='product-price'),
